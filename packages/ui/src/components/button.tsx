...
export const Button = forwardRef(function Button(
  ...
  const buttonElementProps = props as Omit<Headless.ButtonProps, 'as' | 'className'>
  return (
    <Headless.Button
      {...buttonElementProps}
      type={
        buttonElementProps.type === 'submit' || buttonElementProps.type === 'reset'
          ? buttonElementProps.type
          : 'button'
      }
